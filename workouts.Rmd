...
## Option 1
The following regimen outlines a typical week of lifts. The routine is a slightly modified version of [this](https://jackedgorilla.com/chris-pratt-workout-routine/).

Non-lift days should be supplemented with active recovery workouts.An example week could look something like this:
