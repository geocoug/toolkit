...
alias cat='ccat'
alias l='exa -1 -G -l --icons -t modified --git -g'
alias la='exa -1 -G -l --icons -t modified --git -g -a'
# SHORTCUTS
alias c='clear'
alias h='history'
...
alias dev='source ~/envs/dev/bin/acivate'
alias pyenv='/opt/homebrew/opt/python@3.10/Frameworks/Python.framework/Versions/3.10/bin/python3.10 -m venv env && source ./env/bin/activate && python -m pip install --no-cache-dir pre_commit flake8 black isort autoflake > /dev/null 2>&1 && python -m pip freeze > requirements.txt > /dev/null 2>&1'
